...
/***********************************************************************
*
*  Function: outF3(), outF7(), setF3F7(), getF3F7
*
*  Purpose: F3, F7 detect.
*/
static unsigned int levolver_OpenGL_key;
void outF3 ( void){levolver_OpenGL_key = LEVOLVER_PAUSE_OPENGL_KEYPRESS; }
void outF7 ( void){levolver_OpenGL_key = LEVOLVER_BREAK_OPENGL_KEYPRESS; }
void setF3F7(unsigned int * n) {levolver_OpenGL_key = *n;}
void getF3F7(unsigned int * n) {*n = levolver_OpenGL_key;}
#endif
  ...
  switch ( node->type ) 
  {
    ...
    case PAUSE_NODE:
       ...
       if ( l_evolver_mode )
       {
          ...
          //setOpenGL_key();
		  OpenGL_key = LEVOLVER_WAITING_FOR_OPENGL_KEYPRESS;
		  setF3F7(&OpenGL_key);
		  do 
		     {getF3F7(&OpenGL_key); Sleep(16);} 
		  while (OpenGL_key == LEVOLVER_WAITING_FOR_OPENGL_KEYPRESS);
